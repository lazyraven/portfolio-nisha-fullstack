    ...
    <div className="app-shell relative min-h-screen overflow-visible bg-slate-50 text-slate-950 transition-colors duration-500 dark:bg-slate-950 dark:text-slate-100">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="mb-3 flex items-center justify-between gap-4 text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">
            {roadmap.title}
            {/* {roadmap.iframeUrl && (
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-cyan-500 to-purple-500 shadow-lg">
                <Link to={{ pathname: roadmap.id }} target="_blank" rel="noopener noreferrer">
