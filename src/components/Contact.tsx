          ...
          <div className="space-y-6 rounded-[2rem] border border-slate-200/70 bg-white/90 p-8 shadow-[0_30px_80px_-30px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-slate-950/80 dark:shadow-[0_30px_80px_-30px_rgba(0,0,0,0.8)]">
            ...
            <div className="grid gap-4 rounded-[1.75rem] bg-slate-100/90 p-6 dark:bg-slate-900/80">
              <div>
                ...
                <p className="mt-2 text-lg font-semibold text-slate-950 dark:text-white">Open for freelance and full-time work</p>
              </div>
              <div>
                <p className="text-xs uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400">Location</p>
                <p className="mt-2 text-lg font-semibold text-slate-950 dark:text-white">Remote / Global</p>
              </div>
            </div>
          </div>
          <form
            ...
            className="rounded-[2rem] border border-cyan-300/10 bg-white/90 p-8 shadow-[0_40px_120px_-45px_rgba(14,165,233,0.18)] backdrop-blur-xl transition-all duration-500 ease-out hover:-translate-y-1 dark:border-cyan-300/20 dark:bg-slate-950/90"
          >
            ...
            <label className="block">
              ...
              <input
                ...
                className="mt-3 w-full rounded-[1.5rem] border border-slate-300 bg-slate-100/90 px-4 py-3 text-slate-950 outline-none transition duration-300 ease-out hover:border-cyan-300/70 focus:border-cyan-300 focus:ring-2 focus:ring-cyan-300/20 placeholder:text-slate-500 dark:border-slate-700 dark:bg-slate-900/90 dark:text-slate-100"
                required
              />
            </label>
            <label className="block">
            ...
            <button
              type="submit"
              className="btn-primary mt-4 inline-flex w-full items-center justify-center rounded-[1.5rem] bg-cyan-400 px-6 py-3 text-sm font-semibold text-slate-950 transition duration-300 ease-out hover:-translate-y-0.5 hover:bg-cyan-300 focus:outline-none focus:ring-2 focus:ring-cyan-300/40"
            >
              Send Message
            </button>
          </form>
